...
from run_utils import (
    create_timestamped_output_dir as create_timestamped_output_dir_shared,
    save_run_summary as save_run_summary_shared,
)
from ml_pipeline_utils import ml_super_resolution_unet as ml_super_resolution_unet_shared
from cfd_solver_core import (
    BoundaryCondition,
    BoundaryConditions,
    CFDSolver,
    FluidProperties,
...
def create_timestamped_output_dir(base_dir: str = "outputs") -> str:
    ...
    """
    return create_timestamped_output_dir_shared(base_dir)
...
def save_run_summary(filepath: str, info: Dict[str, Dict[str, str]]):
    ...
    """
    return save_run_summary_shared(filepath, info)
...
# ==============================================================================
# ML-Accelerated CFD Workflow Functions - Coarse Simulation
# ==============================================================================
...
def ml_super_resolution_unet(coarse_fields: Dict[str, np.ndarray], 
    ...
    """
    return ml_super_resolution_unet_shared(
...
if __name__ == "__main__":
    ...
    max_iterations_fine_ml = 300  # Max iterations for fine mesh with ML initialization
    ...
    previous_coarse_hdf5 = "C:\\Users\\amirm\\Downloads\\ddd\\Re 300\\bfs_coarse_Re400_10x10_130000_coarse_iterations.h5"
    # =========================================================================
    ...
    previous_normal_hdf5 = "C:\\Users\\amirm\\Downloads\\ddd\\Re 300\\bfs_Re400_400x400_125000_NORMAL_normal.h5"
